          ...
          <>
            ...
            <ul className="flex-1 overflow-y-auto px-5">
              {items.map((item) => {
                ...
                return (
                  <li key={item.product.id} className="flex gap-4 border-b border-stone/50 py-4">
                    {/* Image / placeholder */}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="flex h-7 w-7 items-center justify-center rounded-sm border border-stone/50 text-muted transition-colors duration-200 hover:border-gold/50 hover:text-bone"
